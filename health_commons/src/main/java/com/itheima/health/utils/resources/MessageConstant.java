...
public class MessageConstant {
    ...
    public static final String UPDATE_CHECKITEM_SUCCESS = "更新检查项成功";
    public static final String ADD_CHECKITEM_FAIL = "新增检查项失败";
    public static final String UPDATE_CHECKITEM_FAIL = "更新检查项失败";
    ...
    public static final String SEND_VALIDATECODE_TIMEOUT = "验证码过期";
